...
Public Class frmGridClientes
    ...
    Private Sub btnInserir_Click(sender As Object, e As EventArgs) Handles btnInserir.Click
        ...
        If (frmDetalhesClientes.DialogResult = Windows.Forms.DialogResult.OK) Then
            con.Open()
            Dim cmd As New SqlCommand("INSERT INTO Cliente VALUES ('" &
                                      frmDetalhesClientes.txtNome.Text & "', '" &
    ...
    Private Sub btnVendedores_Click(sender As Object, e As EventArgs)
        frmGridVendedores.ShowDialog()
    End Sub

    Private Sub btnProdutos_Click(sender As Object, e As EventArgs)
