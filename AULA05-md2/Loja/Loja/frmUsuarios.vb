...
Public Class frmUsuarios
    ...
    Private Sub btnInserir_Click(sender As Object, e As EventArgs) Handles btnInserir.Click
        ...
        If (frmDetalhesUsuarios.DialogResult = Windows.Forms.DialogResult.OK) Then
            con.Open()
            Dim cmd As New SqlCommand("INSERT INTO usuarios VALUES (@nome, @usuario, @senha)", con)
            ...
            cmd.Parameters.Add("@senha", SqlDbType.VarChar, 32).Value = frmDetalhesUsuarios.txtSenha.Text
            cmd.ExecuteNonQuery()
