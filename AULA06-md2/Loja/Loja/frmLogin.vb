...
Public Class frmLogin
    ...
    Private Sub btnOk_Click(sender As Object, e As EventArgs) Handles btnOk.Click
        con.Open()
        Dim adp As New SqlDataAdapter("Select * from Usuarios WHERE usuario = @usuario AND senha = @senha", con)
        ...
        If dtb.Rows.Count > 0 Then
            DadosUsuario.usuario = dtb.Rows(0).Item("usuario")
            DadosUsuario.grupo = dtb.Rows(0).Item("grupo")
